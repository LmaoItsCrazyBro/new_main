...
local Version_Config = "V1"
local Version_No_Config = "V1"
local RayfieldFolder = tostring(GameName)
wait(0.1)
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			NotificationBackground = Color3.fromRGB(13, 105, 172),
			NotificationActionsBackground = Color3.fromRGB(13, 105, 172),

			TabBackground = Color3.fromRGB(109, 110, 108),
			TabStroke = Color3.fromRGB(109, 110, 108),
			TabBackgroundSelected = Color3.fromRGB(109, 110, 108),
			TabTextColor = Color3.fromRGB(236, 232, 222),
			SelectedTabTextColor = Color3.fromRGB(109, 110, 108),

			ElementBackground = Color3.fromRGB(50, 50, 50),
			ElementBackgroundHover = Color3.fromRGB(50, 50, 50),
			SecondaryElementBackground = Color3.fromRGB(50, 50, 50),
			ElementStroke = Color3.fromRGB(50, 50, 50),
			SecondaryElementStroke = Color3.fromRGB(50, 50, 50),

			SliderBackground = Color3.fromRGB(193, 202, 222),
			SliderProgress = Color3.fromRGB(132, 182, 141),
			SliderStroke = Color3.fromRGB(58, 163, 255),

			ToggleBackground = Color3.fromRGB(193, 202, 222),
			...
			DropdownSelected = Color3.fromRGB(140, 91, 159),
			DropdownUnselected = Color3.fromRGB(27, 42, 53),

			InputBackground = Color3.fromRGB(58, 125, 21),
			InputStroke = Color3.fromRGB(58, 125, 21),
		...
		DarkBlue = {
			...
			TabStroke = Color3.fromRGB(45, 50, 55), 
			...
			ElementStroke = Color3.fromRGB(45, 50, 55), 
			SecondaryElementStroke = Color3.fromRGB(40, 45, 50), 
			...
			InputStroke = Color3.fromRGB(45, 50, 55), 
...
elseif getgenv().is_on_pc_check and UserInputService.TouchEnabled then
	print("Already ran check for Mobile - Toggle Rayfield GUI.")
elseif getgenv().is_on_pc_check == false and UserInputService.TouchEnabled then
