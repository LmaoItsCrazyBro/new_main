-- Roblox is dumb as shit, they removed "GetCurrentPage" on AvatarEditorService, making the script error, what are they doing bro? swear they're dumb as fuck
...
local catalogResults = getCatalogPage()
