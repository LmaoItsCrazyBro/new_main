...
CMDs[#CMDs + 1] = {NAME = 'SystemBroken', DESC = 'Executes Zacks Easy Hubs modified System Broken script'}
...
CMDs[#CMDs + 1] = {NAME = 'emote [Emote ID]', DESC = 'Play any Roblox emote (not animation)'}
wait()
...
getgenv().fake_out_script = function(args, speaker)
   local root = getRoot(speaker.Character)
